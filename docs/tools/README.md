...
Última atualização: 2026-09-14 17:17 UTC

Total de repositórios: 20
...
| [dgp.cnqp_lib](https://github.com/ifesserra-lab/dgp.cnqp_lib) | Biblioteca Python para coleta e tratamento de dados do Diretório dos Grupos de Pesquisa do CNPq. | Python | Publico | 2026-09-14 |
| [diretoria](https://github.com/ifesserra-lab/diretoria) | Portal de governança e documentação operacional da DPPGE do IFES Campus Serra. | Astro | Publico | 2026-09-14 |
...
| [factor](https://github.com/ifesserra-lab/factor) | Portal de projetos FACTO — dashboard estático (GitHub Pages) | HTML | Publico | 2026-09-14 |
...
| [retrieve_edital](https://github.com/ifesserra-lab/retrieve_edital) | Agente especializado em fazer o download de editais usando Python e Playwright. | Python | Publico | 2026-09-14 |
...
| [src](https://github.com/ifesserra-lab/src) | ETL das ações públicas do SRC/Ifes (Playwright + httpx). Campus e saída parametrizáveis. | Python | Publico | 2026-09-13 |
