...
Última atualização: 2026-07-13 14:09 UTC
...
| [dgp.cnqp_lib](https://github.com/ifesserra-lab/dgp.cnqp_lib) | Biblioteca Python para coleta e tratamento de dados do Diretório dos Grupos de Pesquisa do CNPq. | Python | Publico | 2026-07-13 |
| [diretoria](https://github.com/ifesserra-lab/diretoria) | Portal de governança e documentação operacional da DPPGE do IFES Campus Serra. | Python | Publico | 2026-07-13 |
...
| [gedoc-ifes-busca](https://github.com/ifesserra-lab/gedoc-ifes-busca) | Sem descrição informada. | Rust | Publico | 2026-07-08 |
...
| [horizon_etl](https://github.com/ifesserra-lab/horizon_etl) | ETL Pipeline for extracting, validating, and loading data from multiple sources (Web, API) into Supabase using Prefect and Hexagonal Architecture. | HTML | Publico | 2026-07-12 |
...
| [retrieve_edital](https://github.com/ifesserra-lab/retrieve_edital) | Agente especializado em fazer o download de editais usando Python e Playwright. | Python | Publico | 2026-07-13 |
