...
Última atualização: 2026-09-21 17:29 UTC

Total de repositórios: 21
...
| [dgp.cnqp_lib](https://github.com/ifesserra-lab/dgp.cnqp_lib) | Biblioteca Python para coleta e tratamento de dados do Diretório dos Grupos de Pesquisa do CNPq. | Python | Publico | 2026-09-21 |
| [diretoria](https://github.com/ifesserra-lab/diretoria) | Portal de governança e documentação operacional da DPPGE do IFES Campus Serra. | Astro | Publico | 2026-09-21 |
| [egp](https://github.com/ifesserra-lab/egp) | Site do Escritório de Projetos de Serra. | - | Publico | 2026-09-21 |
| [egressos](https://github.com/ifesserra-lab/egressos) | Impacto de ensino, pesquisa e extensao na carreira de egressos (visao executiva anonimizada) | HTML | Publico | 2026-09-03 |
| [factor](https://github.com/ifesserra-lab/factor) | Portal de projetos FACTO — dashboard estático (GitHub Pages) | HTML | Publico | 2026-09-21 |
...
| [research_hub](https://github.com/ifesserra-lab/research_hub) | Aplicacao desktop para corrigir os dados do horozon | - | Publico | 2026-09-13 |
| [retrieve_edital](https://github.com/ifesserra-lab/retrieve_edital) | Agente especializado em fazer o download de editais usando Python e Playwright. | Python | Publico | 2026-09-21 |
| [sbf](https://github.com/ifesserra-lab/sbf) | pagina do simposio regional de fisica hospedado no campus serra. | Astro | Publico | 2026-09-09 |
...
| [src](https://github.com/ifesserra-lab/src) | ETL das ações públicas do SRC/Ifes (Playwright + httpx). Campus e saída parametrizáveis. | Python | Publico | 2026-09-20 |
