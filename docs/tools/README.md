...
Última atualização: 2026-08-10 12:47 UTC
...
| [dgp.cnqp_lib](https://github.com/ifesserra-lab/dgp.cnqp_lib) | Biblioteca Python para coleta e tratamento de dados do Diretório dos Grupos de Pesquisa do CNPq. | Python | Publico | 2026-08-10 |
| [diretoria](https://github.com/ifesserra-lab/diretoria) | Portal de governança e documentação operacional da DPPGE do IFES Campus Serra. | Astro | Publico | 2026-08-10 |
| [egressos](https://github.com/ifesserra-lab/egressos) | Impacto de ensino, pesquisa e extensao na carreira de egressos (visao executiva anonimizada) | HTML | Publico | 2026-08-03 |
...
| [retrieve_edital](https://github.com/ifesserra-lab/retrieve_edital) | Agente especializado em fazer o download de editais usando Python e Playwright. | Python | Publico | 2026-08-10 |
